...
def get_user_input() -> str:
    # Prompt the user in stdout
    sys.stdout.write("Enter new file name (or empty): ")
    sys.stdout.flush()
    
    # Get user answer from stdin
...
def append_to_file(file_content: str) -> None:
    ...
    try:
        ...
        print(f"[STDERR] Error writing to file '{save_file_path}': {error}", file=sys.stderr)
